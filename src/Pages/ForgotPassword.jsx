              ...
              <Stack spacing={10} pt={2}>
                <Button
                  ...
                  onClick={() => {
                    ...
                    axios
                      .get(`http://localhost:8078/user/forgotpassword?email=${formState.email}`)
                      .then((res) => {
                        setFail(false);
                        setSuccess(true);
                        setSpinner(false);
  ...
  dispatch({type:SIGNUP,payload:res.data.user_id})
              ...
              {success && (
                <Alert status="success">
                  <AlertIcon />
                 OTP sent successfully. Please verify thee otp recieved on your email
                </Alert>
              )}
  ...
  setOtpspinner(false)
    ...
    {otpfail && (
              ...
              {otpsuccess && (
                <Alert status="success">
                  <AlertIcon />
                 Account verified successfully. You will be redirected to password reset page in 3 seconds.
                </Alert>
              )}
